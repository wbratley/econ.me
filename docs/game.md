...
| **4** | Logistics (region graph + transport) — earned and specified: `docs/spatial.md` steps S1–S6; S1 ✅ (places + entity location, #149); S2 (presence gates) is the entry point | engine, additive — every step green with zero spatial data |
